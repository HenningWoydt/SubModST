...
namespace CCSMSM {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality3) {
        std::string data_dir_path = "../data/private/Graph/3/";
        std::string extension = ".edges";
        std::string sol_dir_path = data_dir_path + "GroupClosenessCentrality/";
        ...
        for (std::string &file: files) {
            test_BFSolverVsSolver_GroupClosenessCentrality(file, sol_dir_path);
        }
    }

    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality4) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality5) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality6) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality7) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality8) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality9) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality10) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality11) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality12) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality13) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality14) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality15) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality16) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality17) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality18) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality19) {
    ...
    TEST(GroupClosenessCentralityTest, GroupClosenessCentrality20) {
