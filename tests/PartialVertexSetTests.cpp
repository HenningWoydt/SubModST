...
namespace CCSMSM {
    ...
    void test_BFSolverVsSolver_PartialVertexSet(std::string &data_file_path, std::string &sol_dir_path) {
        return;
    ...
    TEST(PartialVertexSetTest, PartialVertexSet3) {
        std::string data_dir_path = "../data/private/Graph/3/";
        std::string extension = ".edges";
        std::string sol_dir_path = data_dir_path + "PartialVertexSet/";
        ...
        for (std::string &file: files) {
            test_BFSolverVsSolver_PartialVertexSet(file, sol_dir_path);
        }
    }

    TEST(PartialVertexSetTest, PartialVertexSet4) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet5) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet6) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet7) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet8) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet9) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet10) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet11) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet12) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet13) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet14) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet15) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet16) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet17) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet18) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet19) {
    ...
    TEST(PartialVertexSetTest, PartialVertexSet20) {
